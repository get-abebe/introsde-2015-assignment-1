...
public class JAXBMarshaller {
	...
	//Accept a file with xml format and create person using java object and marshaling to xml file.
	public void generateXMLDocument(File xmlDocument) throws ParseException, DatatypeConfigurationException {
		try {
			...
			//create first Person  with id 65
            ...
            //create second person with id 86
